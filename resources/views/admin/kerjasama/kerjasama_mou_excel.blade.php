    ...
    <div class="w-10/12" id="sidebar">
        <div class="bg-slate-700 px-16 py-10 text-white">
            ...
            <div class="w-1/2 p-3 bg-green-500 mb-6 text-sm rounded">
                ...
                <a class="underline font-bold" href="/template_mou.xlsx" target="_blank">Download Disini</a>
            </div>
            <form action="{{route('kerjasama.excel_import_mou_post')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
